...
echo 'building image sample-class-buildstage'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile.buildstage -t sample-class-buildstage .
cd -

echo 'building image sample-class'
cd source
${CONTAINER_RUNTIME} build -f Dockerfile -t sample-class .
cd -
